...
public class Graph {
    ...
    void f1() throws Exception {
         ...
         * Starting from the vertex C (which index is 2), ONLY display the vertex right after C up to the next 4 vertices, and NOT display vertex 'F' (if any, index = 5), but still consider it as one count during traversing the graph.
         ...
         *          C  A  F  H  D  I  B  E  G
         *          A  H  D
         * The output does NOT display vertex 'F' (if any, index = 5), 
    ...
    void f2() throws Exception {
         ...
         * Starting from the vertex C (index = 2). 
