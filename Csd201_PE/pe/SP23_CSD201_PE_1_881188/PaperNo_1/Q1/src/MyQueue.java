...
public class MyQueue {
     ...
     * a new Node into the rear of the queue if the price is less than 100.0
...
//        }
        ...
        if (isEmpty() && isPrime(size)) {
            return;
        }
        enqueue(xName, xPrice, xColor);
     ...
     *   (H, 30.0, 22) (A, 49.8, 8) (B, 45.3, 3) (C, 16.2, 5) (D, 72.5, 4) (F, 66.4, -7)
