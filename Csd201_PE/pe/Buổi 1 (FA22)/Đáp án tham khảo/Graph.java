...
//=================================================================================================
  ...
  void dijkstra(int fro, int to, RandomAccessFile f) throws Exception {
        ...
        //pp la mang chua cac dinh(theo so) la ket qua sau khi thuc hien thuat toan dijkstra (keyword: vertices in shortest path) 2-4-3-1  C E D B
        //ss la mang cac dinh(theo so) duoc chon trong qua trinh thuc hien thuan toan dijkstra  (keyword: vertices selected into the set S) //ban nhap
