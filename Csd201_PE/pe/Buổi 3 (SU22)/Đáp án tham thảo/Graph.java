...
//===========================================================================
  ...
  int count=0;
  void breadth1(boolean [] en, int i, RandomAccessFile f) throws Exception {
    Queue q = new Queue();
    int r,j;
    q.enqueue(i); en[i]=true;
    while(!q.isEmpty()) {
...
//=================================================================================================
  ...
  void f2() throws Exception {
    ...
    //-------------------------------------------------------------------------------------
     /*You must keep statements pre-given in this function.
      ...
      this.dijkstra1(2, 5, f);
      this.dijkstra2(1, 6, f);
    //-------------------------------------------------------------------------------------
    f.writeBytes("\r\n");
    f.close();
   }
  ...
  void dijkstra1(int fro, int to, RandomAccessFile f) throws Exception {
        ...
        f.writeBytes("\r\n");
        //line2
        f.writeBytes("" + d[ss.get(ss.size()-1)]);
        f.writeBytes("\r\n");
    }
  ...
  void dijkstra2(int fro, int to, RandomAccessFile f) throws Exception {
        ...
        f.writeBytes("" + v[ss.get(0)] + " " + v[ss.get(1)]+ " " + v[ss.get(2)]);
